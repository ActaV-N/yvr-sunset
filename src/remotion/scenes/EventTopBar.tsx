...
/**
 * Event masthead: orange rule → "EVENT · {date}" left + time right.
 * Mirrors the sunset reel's TopBar pattern so the brand reads as one family.
 */
export function EventTopBar({ dateLabel, timeLabel }: Props): React.JSX.Element {
